...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("polishcoin Core polishcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  polishcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded polishcoin transaction") + "\n" +
              "  polishcoin-tx [options] -create [commands]   " + _("Create hex-encoded polishcoin transaction") + "\n" +
              "\n";
